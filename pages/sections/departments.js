...
export default function departments() {
    return (
        <section className="mt-20 h-full">
            <h1
                className="mb-2 bg-gradient-to-r from-purple-400 to-blue-600 bg-clip-text sm:text-center text-3xl font-black 
            text-transparent md:text-4xl lg:text-5xl"
            >
                WE CONTINUOUSLY INVEST
                <br /> IN THE FUTURE
            </h1>
            <p className="mx-auto max-w-lg sm:text-center text-title-color">
                DECADES OF EXPERIENCE & EXPERTISE. ONLY PAY FOR WHAT YOU NEED,
                WHEN YOU NEED IT. LOCAL ORLANDO, FL.
            </p>
            <div className="h-full w-full py-10 sm:py-20 md:flex md:flex-col ">
                ...
                <div className="flex justify-start sm:flex sm:justify-center py-5">
                    <button
                        type="button"
                ...
                <ul className="relative z-10 grid grid-cols-1 gap-14 md:gap-5 py-10 px-3 md:grid md:grid-cols-4">
                    <li
                        className="
                    ...
                    >
                        ...
                        <span className="sm:text-center text-sm font-medium text-title-color">
                            Data and Information, converted into Intelligence.
                        </span>
                    </li>
                    <li
                        className="flex-grow-1 relative flex max-w-full items-center gap-5
                    ...
                    >
                       ...
                       "
                        >
                            <h1
                                className="z-10 my-0 sm:mt-0 mt-3 mx-auto flex h-16 w-16 items-center justify-center rounded-full
                             bg-card-color text-2xl font-bold text-gray-200 "
                            >
                                4
                            </h1>
